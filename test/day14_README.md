...
```bash
# Run with stack
stack --resolver lts-21.22 runghc --package containers-0.6.7 --package split-0.2.3.5 -- test/day14.hs

# Or compile
stack --resolver lts-21.22 ghc --package containers-0.6.7 --package split-0.2.3.5 -- test/day14.hs -O2
./day14
```
