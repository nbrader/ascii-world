...
renderFrame gridSize total (idx, frame) = do
    ...
    putStrLn "Part context: [Part 1] shortest path while it exists; [Part 2] first 'No path' marks the blocker."
    ...
    case afPath frame of
        ...
        Nothing -> putStrLn "[Part 2] No path to exit! Blocking byte reached."
