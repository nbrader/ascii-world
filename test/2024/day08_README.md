...
```bash
# Run with stack
stack --resolver lts-21.22 runghc --package containers-0.6.7 --package split-0.2.3.5 -- test/2024/day08.hs

# Or compile for better performance
stack --resolver lts-21.22 ghc --package containers-0.6.7 --package split-0.2.3.5 -- test/2024/day08.hs -O2
./day08
```
...
- **[Day 12: Garden Groups](test/2024/day12.hs)** - Region detection
