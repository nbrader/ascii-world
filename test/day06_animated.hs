...
main = do
    ...
    putStrLn "Guard path animation complete."
...
describe Stepping = "Moving forward"
describe Turning  = "Obstacle ahead - turning right"
describe Exiting  = "Guard stepped outside the mapped area"
describe Looping  = "Detected a repeated state (infinite loop)"
