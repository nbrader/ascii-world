#!/usr/bin/env stack
-- stack --resolver lts-18.22 ghci --package strict-0.4.0.1 --package unordered-containers-0.2.19.1
...
{-
    To build, run the following shell command in this directory:
        stack --resolver lts-20.5 ghc --package strict-0.4.0.1 --package unordered-containers-0.2.19.1 -- '.\day8.hs' -O2
-}
